...
// //motor
// ArmMotor = new SparkMax(Constants.ARM_MOTOR,
...
// armCanEncoder.getAbsolutePosition().getValueAsDouble();
...
// //armPidController.setSetpoint(setPosition, ControlType.kPosition,
// ClosedLoopSlot.kSlot0);
// }// end of constructer
// // public void Intakedown(){
// //
// armPidController.setSetpoint(Constants.ArmConstants.ARM_AT_NEUTRAL_POSITION,
// ControlType.kPosition, ClosedLoopSlot.kSlot0);
// // ArmMotor.set(-.5);
// // }
// public double armDegreesToMotorRotations(double degrees) {
// //System.out.println("Setting Arm Position: " +
// (-degrees*motorRotationsPerArmDegree));
...
// ArmMotor.configure(config2, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);
...
// double sineScalar = Math.sin(Math.toRadians(getArmDegrees() -
// Constants.ARM_BALANCE_DEGREES));
// double feedForward = gravityFF * sineScalar;
// CANcoderConfiguration config37 = new CANcoderConfiguration();
// config37.MagnetSensor.SensorDirection =
// SensorDirectionValue.Clockwise_Positive;
// armCanEncoder.getConfigurator().apply(config37);
// return new InstantCommand(()->
// armPidController.setSetpoint(0.01,ControlType.kPosition,ClosedLoopSlot.kSlot1,
...
// armCanEncoder.getConfigurator().apply(config37);
// return new InstantCommand(()->
// armPidController.setSetpoint(0.269,ControlType.kPosition,ClosedLoopSlot.kSlot0,
// feedForward,SparkClosedLoopController.ArbFFUnits.kPercentOut));
// }
